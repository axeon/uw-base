...
public class AuthQueryParam extends QueryParam {
    ...
    public AuthQueryParam(boolean ignoreException) {
        if (ignoreException) {
            try {
                bindSaasId();
            } catch (Exception e){
     ...
     */
    public AuthQueryParam bindAuthInfo() {
        setSaasId(AuthServiceHelper.getSaasId());
        setMchId(AuthServiceHelper.getMchId());
        setUserId(AuthServiceHelper.getUserId());
        setUserType(AuthServiceHelper.getUserType());
     ...
     */
    public AuthQueryParam bindAuthInfo(boolean bindSaasId, boolean bindUserId, boolean bindMchId, boolean bindUserType) {
        if (bindSaasId) {
            setSaasId(AuthServiceHelper.getSaasId());
        }
        if (bindMchId) {
