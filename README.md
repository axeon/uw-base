...
**UW-Base** 是一套基于Spring Boot 3.x和Spring Cloud
2025.x构建的企业级多子模块基础类库集合。该项目旨在为微服务架构提供完整、稳定、高性能的基础设施支持，涵盖了从数据访问、缓存管理、认证授权到任务调度、日志收集等全方位的功能模块。
...
<parent>
  ...
  <version>2026.0501.0000</version>
  <relativePath/>
</parent>
