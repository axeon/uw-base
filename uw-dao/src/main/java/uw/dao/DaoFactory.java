...
public abstract class DaoFactory {
     ...
     * @throws TransactionException 事务异常
     */
    public abstract <T extends DataEntity> List<T> save(List<T> entityList) throws TransactionException;
     ...
     * @throws TransactionException 事务异常
     */
    public abstract <T extends DataEntity> List<T> save(List<T> entityList, String tableName) throws TransactionException;
     ...
     * @throws TransactionException 事务异常
     */
    public abstract <T extends DataEntity> List<T> save(String connName, List<T> entityList) throws TransactionException;
     ...
     * @throws TransactionException 事务异常
     */
    public abstract <T extends DataEntity> List<T> save(String connName, List<T> entityList, String tableName) throws TransactionException;
     ...
     */
    public abstract QueryParamResult parseQueryParam(QueryParam queryParam);
     ...
     * @throws TransactionException
     */
    public abstract QueryParamResult parseQueryParam(Class cls, QueryParam queryParam);
     ...
     * @throws TransactionException
     */
    public abstract QueryParamResult parseQueryParam(Class cls, String tableName, QueryParam queryParam);
