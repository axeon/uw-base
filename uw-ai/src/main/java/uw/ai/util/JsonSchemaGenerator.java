...
public final class JsonSchemaGenerator {
     ...
     * be overridden by setting the ToolParam#required(),
    ...
    public static String generateForMethodOutput(Method method, SchemaOption... schemaOptions) {
        ...
        ObjectNode returnNode = SUBTYPE_SCHEMA_GENERATOR.generateSchema(returnType);
        String parameterDescription = null;
        if (StringUtils.hasText(parameterDescription)) {
            returnNode.put("description", parameterDescription);
        }
        properties.set(returnType.getTypeName(), returnNode);
        processSchemaOptions(schemaOptions, schema);
