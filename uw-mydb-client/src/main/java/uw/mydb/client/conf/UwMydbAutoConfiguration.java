...
/**
 * uw-mydb-client 自动装配配置类。
 * <p>
 * 注册 {@link MydbClientHelper} Bean，通过其构造方法完成对静态 {@link RestClient}
 * 与 {@link UwMydbClientProperties} 的注入。{@code uw-auth-client} 提供的共享
...
public class UwMydbAutoConfiguration {
    ...
    /**
     * 创建 MydbClientHelper Bean 并完成静态依赖注入。
     * <p>
     ...
     * @return 已完成初始化的 MydbClientHelper 实例
     */
    @Bean
