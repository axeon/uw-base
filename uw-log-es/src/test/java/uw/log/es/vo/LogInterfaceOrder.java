...
public class LogInterfaceOrder extends LogBaseVo implements Serializable {
    ...
    /**
     * @param interfaceConfigId the interfaceConfigId to set
     */
    ...
    /**
     * @param interfaceOrderId the interfaceOrderId to set
     */
    ...
    /**
     * @param interfaceProductId the interfaceProductId to set
     */
    ...
    /**
     * @param interfaceFunction the interfaceFunction to set
     */
