...
public class AuthIdQueryParam extends QueryParam {
    ...
    public AuthIdQueryParam(Long id, boolean ignoreException) {
        this.id = id;
        if (ignoreException) {
            try {
                bindSaasId();
     ...
     */
    public AuthIdQueryParam bindAuthInfo() {
        setSaasId( AuthServiceHelper.getSaasId() );
        setMchId( AuthServiceHelper.getMchId() );
        setUserId( AuthServiceHelper.getUserId() );
        setUserType( AuthServiceHelper.getUserType() );
     ...
     */
    public AuthIdQueryParam bindAuthInfo(boolean bindSaasId, boolean bindUserId, boolean bindMchId, boolean bindUserType) {
        if (bindSaasId) {
            setSaasId( AuthServiceHelper.getSaasId() );
        }
        if (bindMchId) {
